            ...
            {maintenanceCalendarDays.map((cell, index) => (
              cell ? (
                <button
                  ...
                  title={cell.schedules.map((s) => `${s.equipment_name || "장비"} - ${s.work_detail || ""}`).join("\n")}
                >
                  {cell.day}
