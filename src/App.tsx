...
function HomeDashboard({
  ...
  return (
    <section className="modern-home-shell modern-home-shell-pro">
      ...
      <div className="home-dashboard-top-row">
        <div className="home-dashboard-top-left">
        ...
        <div className="modern-home-panel home-notice-panel home-notice-panel-top">
      ...
      <div className="home-photo-shortcut-row">
        <div className="modern-home-panel home-recent-photo-panel">
          <div className="modern-home-panel-head">
            <h3>최근 사진</h3>
            <div className="home-panel-link-group">
          ...
          {recentPhotoItems.length ? (
            <div className="home-recent-photo-grid">
              {recentPhotoItems.map((photo) => (
                <button key={photo.id} className="home-recent-photo-card" onClick={() => setMenuTab?.(photo.tab)}>
        ...
        <div className="modern-home-panel home-shortcut-panel">
          <div className="modern-home-panel-head">
            <h3>바로가기</h3>
          </div>
          <div className="home-shortcut-row home-shortcut-row-inline">
...
.purchase-lookup-page .attachment-group .attachment-preview{
  width:38px !important;
  height:38px !important;
  border-radius:10px !important;
}
.purchase-lookup-page .attachment-preview img{
  width:100% !important;
  height:100% !important;
  object-fit:cover !important;
}
.purchase-lookup-page .pdf-thumb{
...
.home-dashboard-top-row{display:grid;grid-template-columns:minmax(0,1fr) 380px;gap:18px;margin-bottom:18px;align-items:stretch}
.home-dashboard-top-left{display:flex;flex-direction:column;gap:14px;min-width:0}
.home-dashboard-top-row .modern-home-kpis{margin:0}
.home-dashboard-top-row .modern-home-alert-strip{margin:0}
.home-notice-panel-top{min-height:100%;display:flex;flex-direction:column}
.home-notice-panel-top .modern-home-list{flex:1}
.home-dashboard-main-row{display:grid;grid-template-columns:minmax(0,1.05fr) minmax(420px,.95fr);gap:18px;margin-bottom:18px;align-items:start}
...
.home-photo-shortcut-row{display:grid;grid-template-columns:minmax(0,.85fr) minmax(360px,1.15fr);gap:16px;margin:0 0 18px;align-items:stretch}.home-recent-photo-panel,.home-shortcut-panel{min-width:0}.home-recent-photo-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:9px}.home-recent-photo-card{position:relative;min-width:0;border:1px solid #e2e8f0;border-radius:13px;background:#fff;padding:0;overflow:hidden;text-align:left;cursor:pointer;box-shadow:0 8px 18px rgba(15,23,42,.045)}.home-recent-photo-card img{display:block;width:100%;height:62px;object-fit:cover;background:#f1f5f9}.home-recent-photo-card span{position:absolute;left:6px;top:6px;padding:2px 6px;border-radius:999px;background:rgba(15,23,42,.72);color:#fff;font-size:9px;font-weight:950}.home-recent-photo-card b{display:block;padding:7px 7px 1px;color:#0f172a;font-size:11px;font-weight:950;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.home-recent-photo-card small{display:block;padding:0 7px 7px;color:#64748b;font-size:10px;font-weight:850}.home-shortcut-row{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:12px;margin:0 0 18px}.home-shortcut-row.home-shortcut-row-inline{grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;margin:0}.home-shortcut-row button{border:1px solid #e2e8f0;border-radius:14px;background:#fff;padding:13px 10px;display:flex;align-items:center;justify-content:center;gap:8px;cursor:pointer;box-shadow:0 8px 18px rgba(15,23,42,.045)}.home-shortcut-row.home-shortcut-row-inline button{justify-content:flex-start;min-height:58px;padding:14px 13px}.home-shortcut-row span{font-size:20px}.home-shortcut-row b{font-size:13px;font-weight:950;color:#0f172a}.home-month-stat-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:16px}.home-month-stat{border:1px solid #e2e8f0;border-radius:17px;background:#fff;padding:22px 20px;text-align:left;cursor:pointer;box-shadow:0 12px 28px rgba(15,23,42,.06);min-height:118px}.home-month-stat span{display:block;font-size:13px;font-weight:950;color:#334155}.home-month-stat b{display:block;margin-top:14px;font-size:26px;font-weight:950;letter-spacing:-.7px}.home-month-stat small{display:block;margin-top:11px;color:#64748b;font-size:12px;font-weight:850}.home-month-stat.blue{background:#f6f9ff;border-color:#bfdbfe}.home-month-stat.blue b{color:#1455d9}.home-month-stat.purple{background:#faf7ff;border-color:#ddd6fe}.home-month-stat.purple b{color:#6d28d9}.home-month-stat.green{background:#f0fdf4;border-color:#bbf7d0}.home-month-stat.green b{color:#059669}.home-month-stat.amber{background:#fffaf0;border-color:#fde68a}.home-month-stat.amber b{color:#d97706}@media(max-width:1200px){.home-dashboard-top-row,.home-dashboard-main-row,.home-photo-shortcut-row{grid-template-columns:1fr}.home-week-calendar-grid{grid-template-columns:repeat(7,minmax(120px,1fr));overflow-x:auto;padding-bottom:4px}.home-shortcut-row{grid-template-columns:repeat(3,1fr)}.home-shortcut-row.home-shortcut-row-inline{grid-template-columns:repeat(3,1fr)}.home-recent-photo-grid{grid-template-columns:repeat(4,minmax(0,1fr))}.home-month-stat-grid{grid-template-columns:repeat(2,1fr)}}
