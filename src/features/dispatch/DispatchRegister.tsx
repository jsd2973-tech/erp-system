  ...
  return (
    <section className="dispatch-panel">
      ...
      <div className="dispatch-form-grid order-form-grid">
        ...
        <label className="dispatch-field-total"><span>총 물량(루베) *</span><input inputMode="decimal" value={form.total_volume} onChange={(event) => setForm({ ...form, total_volume: event.target.value })} placeholder="340" /></label>
